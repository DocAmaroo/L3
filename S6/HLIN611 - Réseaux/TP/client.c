	...
	printf("\n____ Quota réel\n");
	printf("Client : Au total j'aurais du envoyer %i octets et le serveur me répond qu'il a reçu : %d octets \n", octetSended, octetReceived) ;
	printf("Client : La perte réel d'octet s'élève à %d%%\n\n", (100-(octetReceived*100)/realOctetSended) );
